...
function initDataGrid() {
	 ...
	 [[
		...
		{field:"applyCount",title:'申领数量',minwidth:80,editor:{ type:'numberbox',options:{width:80},align:'right',fmType:'int'},formatter:function(value,rowData,rowIndex){if (value == undefined)return 0;else return value;}},
		{field:"checkCount",title:'经办人审核数量',minwidth:80},
		{field:"leaderCheckCount",title:'行装科领导审核数量',minwidth:80}
	 ...
	 var dataGridOptions ={rownumbers:false,checkbox:true,isQuery:true,pagination:false,height:'auto',onLoadSuccess:null};
...
function setCustomQueryCondition() {
	...
	categoryQc.value1 = categoryPk;//31fd2d39-49ab-42ec-bf2f-f1ff6d111e56
